	...
	public function getOpeningHoursSpecification() {
		...
		if ( ! isset( $this->_openingHoursSpecification ) || empty( array_filter( $this->_openingHoursSpecification ) ) ) {
			if ( isset( $this->_local['openingHoursSpecification'] ) && ! empty( $this->_local['openingHoursSpecification'] ) ) {
				$this->_openingHoursSpecification = $this->_local['openingHoursSpecification'];

				return SQP_Classes_ObjController::getDomain( 'SQP_Models_Domain_Jsonld_OpeningHours', $this->_openingHoursSpecification )->toArray();
			}
		}
