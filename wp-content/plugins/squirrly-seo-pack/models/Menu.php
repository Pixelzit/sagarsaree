...
class SQP_Models_Menu {
	...
	public function getMainMenu() {
		return array(
			...
			'sq_redirects'   => array(
				'title'      => esc_html__( "Redirects", 'squirrly-seo-pack' ) . ' ' . apply_filters( 'sqp_badge_new', false ),
				'parent'     => 'sq_dashboard',
			...
			'sq_jsonld'      => array(
				'title'      => esc_html__( "Reusable Schemas", 'squirrly-seo-pack' ) . ' ' . apply_filters( 'sqp_badge_new', false ),
				'parent'     => 'sq_dashboard',
				'capability' => 'edit_posts',
	...
	public function loadPackFeatures( $features ) {
		...
		if ( ! in_array( "Redirects", array_column( $features, 'title' ) ) ) {
			$features[] = array(
				'title'       => "Redirects" . ' ' . apply_filters( 'sq_badge_new', false ),
		...
		if ( ! in_array( "404 Monitor", array_column( $features, 'title' ) ) ) {
			$features[] = array(
				'title'       => "404 Monitor"  . ' ' . apply_filters( 'sq_badge_new', false ),
		...
		if ( ! in_array( "Custom Rich Snippets", array_column( $features, 'title' ) ) ) {
			$features[] = array(
				'title'       => "Custom Rich Snippets" . ' ' . apply_filters( 'sq_badge_new', false ),
		...
		if ( ! in_array( "Reusable Schemas", array_column( $features, 'title' ) ) ) {
			$features[] = array(
				'title'       => "Reusable Schemas" . ' ' . apply_filters( 'sq_badge_new', false ),
		...
		$features[] = array(
			'title'       => "Copyright Free Images" . ' ' . apply_filters( 'sq_badge_new', false ),
