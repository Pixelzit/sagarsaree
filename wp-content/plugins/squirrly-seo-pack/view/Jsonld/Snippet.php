                ...
                <div id="sqtabjson<?php echo esc_attr( $view->post->hash ) ?>2" class="sq-tab-panel" role="tabpanel">
                    ...
                    <div class="sq-col-12 sq-p-0 sq-m-0 sq-small">
                        ...
                        <form method="post" target="_blank" action="https://search.google.com/test/rich-results">
                            <button type="submit" class="sq-btn sq-btn-light sq-btn-sm  sq-text-dark sq-border sq-px-4 sq-mx-2  sq-float-right">
                                <i class="fa-brands fa-google"></i> <?php echo esc_html__( "Validate JSON-LD", 'squirrly-seo-pack' ) ?>
                            </button>
                            <textarea name="code_snippet" class="code_snippet" style="display: none"></textarea>
                        </form>
